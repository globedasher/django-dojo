...
while start < length / 2:
    ...
    for element in range(start,length):
        ...
        # the list.
        if check_list[length - 1 - element] > max_temp:
            max_temp = check_list[length - 1 - element]
            max_position =  length - 1 - element
